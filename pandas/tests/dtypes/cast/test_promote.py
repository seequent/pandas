...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("int8", np.iinfo("int16").max + 1, "intc"),
        ...
        ("uint8", np.iinfo("uint16").max + 1, "uintc"),
        ("uint8", np.iinfo("int32").max + 1, "uintc"),
        ...
        ("int16", np.iinfo("int16").max + 1, "intc"),
